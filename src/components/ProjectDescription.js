...
<div>
  ...
  5 stars based on 2 reviews.
         ...
         <th><h2 className="description">Ecommerce Mobile Applications<br></br></h2></th>
         <h3>Features</h3>
         <tr><td>light and fast</td></tr>
         <tr><td>CrossPlatfrom(Runs on both iOS and Android</td></tr>
         <tr><td>Allows customers to purchase records </td></tr>
         <tr><td>Allows customers to track their Good delivery Status</td></tr>
         <tr><td>Customers cand download and print reports and recipts</td></tr>
         <tr><td>web based admin</td></tr>
         
         <tr><td><button className="descriptionbutton"><FaWhatsapp/>REQUEST APP</button></td><td><button className="descriptionbutton"><FaChild/>JOIN WHATSAPP GROUP</button></td></tr>
